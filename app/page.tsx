...
const projects = [
  ...
  },
  {
    ...
    subhead:
      "Complete web application with invite-code access, engagement dashboards, automated notifications, and content moderation — running with zero manual admin effort.",
    tagline:
